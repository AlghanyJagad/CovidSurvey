        ...
        <div class="row no-gutters block-9">
            <form action="hasil.php" class="bg-light p-4 p-md-5 contact-form" method="post">
              ...
              <div class="form-group">
                <tr>
                  <td><input type="text" class="form-control" onkeypress="return event.charCode < 48 || event.charCode  >57" name="nama" placeholder="Nama" required></td>
                </tr>
              </div>
              <div class="form-group">
                <tr>
                  <td><input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="umur" placeholder="Umur" maxlength="2" required></td>
                </tr>
              </div>
<script>
...
return true;
    ...
    <h1 class="heading">16. SAYA TIDAK MENSOSIALISASIKAN CHECK LIST PENILAIAN RESIKO PRIBADI INI KEPADA KELUARGA DIRUMAH</h1>
    <label class="container">YA
