...
if(isset($_POST['selesai'])){
    $redirect = "https://covidalghany.000webhostapp.com/";
}
?>
<!DOCTYPE html>
<html lang="en">
    			...
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
                    ...
                    <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span><?php echo ''.$nama.''?></span></li>
		            </ul>
                    ...
                    <p>Ayo kurangi penyebaran virus covid-19 dengan mengurangin interaksi sosial #DIRUMAHAJA #TETAPSEHAT</p>
                            <div class = "container">
                                        <a href="https://covidalghany.000webhostapp.com/" class="btn btn-primary py-3 px-5">SELESAI</a>
                            </div>
		          </div>
		        </div>
	        </div>
